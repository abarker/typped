...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inittypped(void); /*proto*/
PyMODINIT_FUNC inittypped(void)
#else
PyMODINIT_FUNC PyInit_typped(void); /*proto*/
PyMODINIT_FUNC PyInit_typped(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_typped(void)", 0);
 ...
 */
  __pyx_t_4 = PyDict_New(); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
