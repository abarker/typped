...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "typped.__init__",
        "sources": [
            "src/typped/__init__.py"
        ]
    },
    "module_name": "typped.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__typped____init__
#define __PYX_HAVE_API__typped____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'typped.__init__' */
#define __Pyx_MODULE_NAME "typped.__init__"
extern int __pyx_module_is_main_typped____init__;
int __pyx_module_is_main_typped____init__ = 0;

/* Implementation of 'typped.__init__' */
...
static int __pyx_pymod_exec_typped(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_typped},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_pratt_parser, __pyx_k_pratt_parser, sizeof(__pyx_k_pratt_parser), 0, 0, 1, 1},
  ...
  {&__pyx_n_u_typped, __pyx_k_typped, sizeof(__pyx_k_typped), 0, 1, 0, 1},
  {0, 0, 0, 0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC inittypped(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC inittypped(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_typped(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_typped(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_typped(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'typped' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_typped(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("typped", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_typped____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_typped) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "typped")) {
      if (unlikely(PyDict_SetItemString(modules, "typped", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __pyx_t_5 = __Pyx_Import(__pyx_n_s_pratt_parser, __pyx_t_4, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (__pyx_import_star(__pyx_t_5) < 0) __PYX_ERR(0, 14, __pyx_L1_error);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "typped/__init__.py":15
 * 
 * from .pratt_parser import *
 * from .pratt_types import *             # <<<<<<<<<<<<<<
 * from .lexer import *
 ...
 */
  ...
  __Pyx_INCREF(__pyx_n_s_);
  __Pyx_GIVEREF(__pyx_n_s_);
  PyList_SET_ITEM(__pyx_t_5, 0, __pyx_n_s_);
  __pyx_t_4 = __Pyx_Import(__pyx_n_s_pratt_types, __pyx_t_5, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (__pyx_import_star(__pyx_t_4) < 0) __PYX_ERR(0, 15, __pyx_L1_error);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "typped/__init__.py":16
 * from .pratt_parser import *
 * from .pratt_types import *
 * from .lexer import *             # <<<<<<<<<<<<<<
 * from .shared_settings_and_exceptions import *
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_n_s_);
  PyList_SET_ITEM(__pyx_t_4, 0, __pyx_n_s_);
  __pyx_t_5 = __Pyx_Import(__pyx_n_s_lexer, __pyx_t_4, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (__pyx_import_star(__pyx_t_5) < 0) __PYX_ERR(0, 16, __pyx_L1_error);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "typped/__init__.py":17
 * from .pratt_types import *
 * from .lexer import *
 * from .shared_settings_and_exceptions import *             # <<<<<<<<<<<<<<
 * from .ebnf_classes_and_operators import *
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_n_s_);
  PyList_SET_ITEM(__pyx_t_5, 0, __pyx_n_s_);
  __pyx_t_4 = __Pyx_Import(__pyx_n_s_shared_settings_and_exceptions, __pyx_t_5, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (__pyx_import_star(__pyx_t_4) < 0) __PYX_ERR(0, 17, __pyx_L1_error);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "typped/__init__.py":18
 * from .lexer import *
 * from .shared_settings_and_exceptions import *
 * from .ebnf_classes_and_operators import *             # <<<<<<<<<<<<<<
 * from .helpers import *
 * 
 */
  __pyx_t_4 = PyList_New(1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_INCREF(__pyx_n_s_);
  __Pyx_GIVEREF(__pyx_n_s_);
  PyList_SET_ITEM(__pyx_t_4, 0, __pyx_n_s_);
  __pyx_t_5 = __Pyx_Import(__pyx_n_s_ebnf_classes_and_operators, __pyx_t_4, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (__pyx_import_star(__pyx_t_5) < 0) __PYX_ERR(0, 18, __pyx_L1_error);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "typped/__init__.py":19
 * from .shared_settings_and_exceptions import *
 * from .ebnf_classes_and_operators import *
 * from .helpers import *             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_n_s_);
  PyList_SET_ITEM(__pyx_t_5, 0, __pyx_n_s_);
  __pyx_t_4 = __Pyx_Import(__pyx_n_s_helpers, __pyx_t_5, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (__pyx_import_star(__pyx_t_4) < 0) __PYX_ERR(0, 19, __pyx_L1_error);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "typped/__init__.py":2
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init typped.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init typped.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
