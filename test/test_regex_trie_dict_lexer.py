...
# def testSemanticsOfPythonRegex():
...
#    """Test the invariants that a map should have, from PEP 3119."""
...
#    td.printTree()
#    del td["moneys"]
#    assert not td.has_key("moneys")
#    if not "money" in td:
#       fail("The string should be in the dict.")
#    assert td.has_key("money") 
#    td["money"] = 55
#    assert td["money"] == 55
#    mappingInvariants(td)
# 
...
#          seedExample += 1
#          pythonPatt, triePatt, example = genRandomRegex(maxLength=40, maxNumParts=3,
#                                    seedPattern=seedPattern, seedExample=seedExample)
#          print(triePatt, "   ", example)
#          print(pythonPatt, "   ", example)
