...
REGENERATE_C_CODE = True # Regenerate C code with Cython or compile existing code.
...
OLD_CWD = os.getcwd()
os.chdir(os.path.abspath(os.path.dirname(__file__))) # Make paths relative setup.py dir.

cmdclass = {} # Not currently used.

# TODO: Update the regex_trie_dict file for latest setup, too.
...
# Set up the .c files as package data.
if BUILD_DIR is None:
    CYTHON_C_FILES = glob.glob(os.path.join(PACKAGE_CODE_DIR, "*.c"))
else:
